...
interface Project {
  ...
  image: string;
  tech: string[];
  category: "AI & ML" | "Data" | "Web Dev" | "Games";
  details: string;
...
const categories = ["All Projects", "AI & ML", "Data", "Web Dev", "Games"];
  ...
  return (
    <section id="projects" className="px-6 py-20">
      <div className="mx-auto max-w-5xl">
        ...
        <h2 className="text-4xl md:text-5xl font-bold tracking-tight text-foreground text-center mb-10">
          Projects
        </h2>
